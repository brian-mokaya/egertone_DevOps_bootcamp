...
frontend_dir = os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'frontend/build'))
...
# Remove /results and /monitoring routes as they are handled by React Router
